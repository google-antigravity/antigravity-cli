...
const CONSTANT_VALUES = {
  GLOBALS: {
    LABELS: {
      ...
      SECURITY: 'security',
      STAT_AWAITING_RESPONSE: 'stat:awaiting response',
      STAT_COMMUNITY_SUPPORT: 'stat:community support',
      STAT_INVESTIGATING: 'stat:investigating',
      SUBTYPE_ARM64: 'subtype:arm64',
      SUBTYPE_MACOS: 'subtype:macOS',
      SUBTYPE_SSH_REMOTE: 'subtype:ssh/remote',
      SUBTYPE_UBUNTU_LINUX: 'subtype:ubuntu/Linux',
      SUBTYPE_WINDOWS: 'subtype:windows',
      SUPPORT: 'support',
      WONTFIX: 'wontfix'
    },
    STATE: { CLOSED: 'closed' },
